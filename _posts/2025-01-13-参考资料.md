...
- windows和linux下的venv创建和启动
  <details>
   <summary>windows</summary>  
    <textarea id="exportSaveInput" style="width:800px;margin-top:5px;height:100px;font-size:16px;">
    创建venv环境
    python -m venv ./.venv
...
-  [Click-python命令行库中文文档](https://click-docs-zh-cn.readthedocs.io/zh/latest/)
-  [Questionary命令行式交互gui文档](https://questionary.readthedocs.io/en/stable/)
...
## 下载ytb视频, yt-dlp
  ...
  - 常用指令
    ...
    <textarea id="exportSaveInput" style="width:800px;margin-top:5px;height:350px;font-size:16px">
